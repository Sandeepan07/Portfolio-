        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
         { <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Sandeepan07/weather-app-main.git"
              demoLink="https://weather-app-sandeepan.vercel.app/"
            />
          </Col>}
          ...
          {<Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Sandeepan07/netflix-clone-landingPage.git"
              demoLink="https://netflix-clone-landing-page-sandeepan.vercel.app/"
            />
          </Col>}
           ...
           {<Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Sandeepan07/Rainbow-boder.git"
              demoLink="https://rainbow-boder-sandeepan.vercel.app/"              
            />
          </Col>}
